...
public class Requests {
        ...
        public static void main(String[] args) {
            ...
            Beatmaker beatmaker = new Beatmaker("Loqimean"); 
            ...
            Track track1 = new Track("Накануне", artist2, "Rap", 2014, 123, beatmaker);
            Track track2 = new Track("Переплетено", artist2, "Rap", 2014, 223, beatmaker);
            Track track3 = new Track("Башня из слоновой кости", artist2, "Rap", 2014, 178, beatmaker);
            Track track4 = new Track("Havana", new Artist("Camila Cabello"), "Pop", 2017, 234, beatmaker);
            Track track5 = new Track("My Blood", artist3, "Pop-rock", 2018, 145, beatmaker);
            Track track6 = new Track("Chlorine", artist3, "Pop-rock", 2018, 153, beatmaker);
            Track track7 = new Track("Мой кайф", artist4, "Cloud rap", 2018, 238, beatmaker);
            Track track8 = new Track("Не По Пути", artist4, "Cloud rap", 2018, 293, beatmaker);
            Track track9 = new Track("Кукла колдуна", new Artist("Король и шут"), "Rock", 1999, 300, beatmaker);
            Track track10 = new Track("Сахарный человек", artist1,"Rap", 2018, 113, beatmaker);
            Track track11 = new Track("Банановый сок", artist1, "Rap", 2018, 111, beatmaker);
            Track track12 = new Track("Суперчуитс", artist1, "Rap", 2018, 213, beatmaker);
            Track track13 = new Track("Дай пять!", artist1, "Rap", 2018, 132, beatmaker);
            Track track14 = new Track("Фреймдата", artist1, "Rap", 2018, 423, beatmaker);   
            Track track15 = new Track("Пустота", artist1, "Rap", 2018, 333, beatmaker);
            Track track16 = new Track("Вечный жид", artist2, "Rap", 2011, 623, beatmaker);
            Track track17 = new Track("Восточный Мордор", artist2, "Rap", 2011, 113, beatmaker);
            Track track18 = new Track("До сих пор MC", artist2, "Rap", 2011, 323, beatmaker);
